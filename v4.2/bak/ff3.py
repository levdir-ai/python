...
def display_user_details(stdscr, user_manager, user_id):
    ...
    if user:
        ...
        full_name_input = ""
        stdscr.move(5, 20)  # Move cursor to input position
        ...
        while True:
            ...
            stdscr.addstr(5, 20, full_name_input.ljust(30))  # Display input
            stdscr.clrtoeol()  # Clear to end of line
            stdscr.move(5, 20 + len(full_name_input))  # Move cursor to end of input
        
        stdscr.addstr(6, 2, "Edit Email: ")
        email_input = ""
        stdscr.move(6, 20)  # Move cursor to input position
        ...
        while True:
            ...
            stdscr.addstr(6, 20, email_input.ljust(30))  # Display input
            stdscr.clrtoeol()  # Clear to end of line
            stdscr.move(6, 20 + len(email_input))  # Move cursor to end of input
