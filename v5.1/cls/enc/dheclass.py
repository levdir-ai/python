...
class dhe:
	...
	def GetPublicKeyExp(self):
		...
		logger.warning("		DHE Public key export: %s....%s",pkexp[27:37].decode('utf-8'),pkexp[-37:-26].decode('utf-8'))
		return pkexp

#import pub key in GetPublicKeyExp() format
	def PublicKeyImp(self, pubkey):
		logger.warning("		DHE Public key import: %s....%s",pubkey[27:37].decode('utf-8'),pubkey[-37:-26].decode('utf-8'))
